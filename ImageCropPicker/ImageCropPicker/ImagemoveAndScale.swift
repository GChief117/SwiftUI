...
import SwiftUI
  ...
  struct ImageMoveAndScaleSheet: View {
      ...
      @State public var inputW: CGFloat = 750.5556577
      @State public var inputH: CGFloat = 1336.5556577
      
      @State public var theAspectRatio: CGFloat = 0.0
      ...
      @State public var profileImage: Image?
      @State public var profileW: CGFloat = 0.0
      @State public var profileH: CGFloat = 0.0
      
      ///Zoom and Drag ...
      @State public var currentAmount: CGFloat = 0
      @State public var finalAmount: CGFloat = 1
      ...
      var body: some View {
          ...
          ZStack {
              ...
              VStack {
                  Text((profileImage != nil) ? "Move and Scale" : "Select a Photo by tapping 📷")
      ...
      public func HoleShapeMask() -> Path {
      ...
      public func resetImageOriginAndScale() {

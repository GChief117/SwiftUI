...
final class CoordinatorPointCloud: MTKCoordinator {
    ...
    //this expands the size of the given matrix we have
    ...
    /*
     ...
     You have a given matrix
     
     The orientation is set to be a 4x4 matrix
     how do you transform the space set in place
